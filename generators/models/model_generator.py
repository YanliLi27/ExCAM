...
def model_generator(model_flag, weights_path, task, general_args, in_channel, num_classes, layer_preset=True):
    # model setting ------------------------------------------------------------------------#
    ...
    # model randomization -----------------------------------------------------------------#
    if general_args.randomization:
        from utils.model_destroyer import model_destroyer
        model = model_destroyer(model, model_flag, general_args.random_severity)
